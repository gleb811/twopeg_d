...
cout << "Fermi flag " << flag_fermi << "  -  with Fermi smearing (this mode is fixed in TWOPEG-D)" << "\n";
...
cout << "FOR RAD MODE:\n";
cout <<"	--tden		0.169	Target density   (g/cm^3)\n";
cout <<"	--trdln		745.4	Target radlenth  (cm)\n";
cout <<"	--tz		1    	Target Z	    \n";
cout <<"	--ta		2    	Target A	    \n";
...
cout <<"	--flagfermi	1     	Fermi smearing, 0 - no, 1 - yes (for twopeg-d always 1)\n";
