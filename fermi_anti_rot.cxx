...
//As an output it gives the four-momenta of the final hadrons (P4_1, P4_2, and P4_3) in the Lab frame.
 ...
 void fermi_anti_rot(Float_t W, Float_t Q2,Float_t E_beam, Float_t E_beam_fermi,Float_t phi_e, Float_t theta_rot2, TLorentzVector &P4_1, TLorentzVector &P4_2, TLorentzVector &P4_3, TLorentzVector P4_E_prime_Lab) {
...
if ((fabs(P4_E_prime_qLab[0]-P4_E_prime_Lab[0])>0.0001)||(fabs(P4_E_prime_qLab[1]-P4_E_prime_Lab[1])>0.0001)||(fabs(P4_E_prime_qLab[2]-P4_E_prime_Lab[2])>0.0001)||(fabs(P4_E_prime_qLab[2]-P4_E_prime_Lab[2])>0.0001))  {

cout <<P4_E_prime_qLab[0]<<" "<< P4_E_prime_qLab[1]<<" "<<P4_E_prime_qLab[2]<<" "<<P4_E_prime_qLab[3]<<" e' transformed\n";
cout <<P4_E_prime_Lab[0]<<" "<< P4_E_prime_Lab[1]<<" "<<P4_E_prime_Lab[2]<<" "<<P4_E_prime_Lab[3]<<" e' Lab ini\n";
