...
//hist_fill(..) - it fills the histogram, which are needed for illustrative and testing puposes.
...
P4_Eini_lab_rad.SetXYZT(0.,0.,E_beam_new, E_beam_new);
  
//P4_Pini - the four-momentum of the initial proton at rest, no rad eff
//P4_Eini - the four-momentum of the incomimg electron in the Lab frame, no rad eff
//P4_E_prime - the four-momentum of the scattered electron in the Lab frame
...
if (flag_radmod == 0) 			    P4_0_miss_2 = P4_Pini_fermi+P4_Eini    -P4_E_prime    -P4_PIP-P4_Pfin-P4_PIM;
if ((flag_radmod == 1)||(flag_radmod == 2)) P4_0_miss_2 = P4_Pini_fermi+P4_Eini_new-P4_E_prime_new-P4_PIP-P4_Pfin-P4_PIM;    

					    P4_pim_miss =   P4_Pini      +P4_Eini    -P4_E_prime    -P4_PIP-P4_Pfin;
if (flag_radmod == 0) 			    P4_pim_miss_2 = P4_Pini_fermi+P4_Eini    -P4_E_prime    -P4_PIP-P4_Pfin;
if ((flag_radmod == 1)||(flag_radmod == 2)) P4_pim_miss_2 = P4_Pini_fermi+P4_Eini_new-P4_E_prime_new-P4_PIP-P4_Pfin; 
