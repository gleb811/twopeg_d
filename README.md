TWOPEG-D is an event generator for pi+pi- electroproduction off protons in deuterium nuclei.
...
The generator includes radiative effects according to Mo&Tsai. 

The generator accounts for the effects of the initial proton motion, but disregards FSI and off-shelness effects. The Fermi momentum of the initial proton is generated according to the Bonn potential (see CLAS12-NOTE-2017-014).
...
fermi_bonn.cxx - generates the Fermi momentum of the initial proton according to the Bonn potential,

fermi_rot.cxx - performs the Lab-->quasiLab transformation,

fermi_anti_rot.cxx performs the quasiLab-->Lab transformation,
